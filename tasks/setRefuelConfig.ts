...
task("setRefuelConfig", "Set the parameters used to add funds to upkeeps")
  ...
  .addParam("stationUpkeepMinBalance", "The minimum balance for the main station upkeep after which is considered underfunded")
  .addParam("minDelay", "The minimum delay between consecutive refuels of the same upkeep (except for the main station upkeep)")
