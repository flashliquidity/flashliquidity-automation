...
task("registerUpkeep", "Register a new upkeep and add it to the list of monitored upkeeps")
	.addParam<string>("name", "The name of the upkeep")
	.addParam<string>("contract", "The address of your Automation-compatible contract")
  .addParam<number>("gasLimit", "The maximum gas limit that will be used for txns by this upkeep")
  .addOptionalParam<number>("triggerType", "0 is Conditional upkeep, 1 is Log trigger upkeep", 0)
  .addOptionalParam<string>("checkData", "checkData is a static input that you can specify now which will be sent into your checkUpkeep or checkLog, see interface.", "0x")
  .addOptionalParam<string>("triggerConfig", "The configuration for your upkeep. 0x for conditional upkeeps.", "0x")
  .addOptionalParam<string>("offchainConfig", "Leave as 0x, or use this field to set a gas price threshold for your upkeep.", "0x")
	.addOptionalParam<bigint>("amount", "The LINK token amount to fund the upkeep", 5000000000000000000n)
    ...
    const registrationParams = ethers.AbiCoder.defaultAbiCoder().encode(
      ...
      [
        [
          ...
          taskArgs.amount           // uint96 amount = 1000000000000000000;
        ]
      ]
    )
